 ...
 * una singola variabile x che determinera' il numero di colonne e il numero di righe. Per evitare di utilizzare una variabile
 * globale si e' optato per scrivere il valore della x su un file ".matrice.txt". Il valore viene scritto e letto ogni volta che serve
 * attraverso funzioni apposite, al termine del gioco il file viene cancellato.
 ...
 * Si e' cercato di ridurre al minimo le definizioni delle variabili globali infatti ne e' stata impostata solo una chiamata matrice
 */
